...
<title>后台管理 - 飞鸽二手自行车-网上二手自行车商城</title>
...
<div id="position" class="wrap">
	您现在的位置：<a href="index.jsp">飞鸽二手自行车-网上二手自行车商城</a> &gt; 管理后台
</div>
		...
		<div class="manage">
			<table class="list">
				...
				<tr>
					...
					<td>${n.EN_TITLE }</td>
					<td class="w1 c"><a href="upnews?id=${n.EN_ID }">修改</a> <a href="javascript:Delete2(${n.EN_ID });">删除</a></td>
				</tr>
				</c:forEach>
			</table>
			当前:${cpage }/${tpage }页
			<a href="newsselect?cp=1">首页</a>
			<a href="newsselect?cp=${cpage-1<=0 ?1:cpage-1}">上一页</a>
			<a href="newsselect?cp=${cpage+1>=tpage ? tpage : cpage+1 }">下一页</a>
			<a href="newsselect?cp=${tpage }">尾页</a>
			<select onchange="jumpnews(this.value)">
